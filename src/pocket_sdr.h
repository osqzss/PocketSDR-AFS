...
// TEB: Expand max number of symbols for AFS navigation message 
//#define SDR_MAX_NSYM   2000     // max number of symbols
#define SDR_MAX_NSYM   6800     // max number of symbols (> 6000 + 68)
#define SDR_MAX_DATA   4096     // max length of navigation data
#define SDR_N_CORR     (4+81)   // number of correlators
// TEB: Expand max number of correlator history for AFS navigation message 
//#define SDR_N_HIST     5000     // number of P correlator history
#define SDR_N_HIST     5000
...
// TEB: Inverted Q sign flag for MAX2771
#define SDR_QSIGN_NOM 0         // SDR Q sign: nominal
#define SDR_QSIGN_INV 1         // SDR Q sign: inverted
